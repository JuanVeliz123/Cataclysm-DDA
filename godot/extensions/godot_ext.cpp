...
class CDDAHost : public godot::Node
{
    ...
    protected:
        static void _bind_methods()
        {
            ...
            godot::ClassDB::bind_method( godot::D_METHOD( "debug_open_follower_rules" ),
                                        &CDDAHost::debug_open_follower_rules );
            godot::ClassDB::bind_method( godot::D_METHOD( "debug_open_compare_item_menu" ),
                                        &CDDAHost::debug_open_compare_item_menu );
            godot::ClassDB::bind_method( godot::D_METHOD( "debug_open_end_screen" ),
                                        &CDDAHost::debug_open_end_screen );
            ...
            godot::ClassDB::bind_method( godot::D_METHOD( "scenario_discover_map_extra", "map_extra" ),
                                        &CDDAHost::scenario_discover_map_extra );
            ...
            godot::ClassDB::bind_method( godot::D_METHOD( "study_zone_active" ),
                                        &CDDAHost::study_zone_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "study_zone_generation" ),
                                        &CDDAHost::study_zone_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_study_zone_state" ),
                                        &CDDAHost::get_study_zone_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "study_zone_action", "action" ),
                                        &CDDAHost::study_zone_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "study_zone_toggle", "skill_index",
                                        "npc_index" ), &CDDAHost::study_zone_toggle );
            godot::ClassDB::bind_method( godot::D_METHOD( "study_zone_set_filter", "text" ),
                                        &CDDAHost::study_zone_set_filter );
            godot::ClassDB::bind_method( godot::D_METHOD( "follower_rules_active" ),
                                        &CDDAHost::follower_rules_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "follower_rules_generation" ),
                                        &CDDAHost::follower_rules_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_follower_rules_state" ),
                                        &CDDAHost::get_follower_rules_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "follower_rules_action", "action" ),
                                        &CDDAHost::follower_rules_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "follower_rules_toggle", "flag" ),
                                        &CDDAHost::follower_rules_toggle );
            godot::ClassDB::bind_method( godot::D_METHOD( "follower_rules_default_rule", "flag" ),
                                        &CDDAHost::follower_rules_default_rule );
            godot::ClassDB::bind_method( godot::D_METHOD( "follower_rules_set", "group", "value" ),
                                        &CDDAHost::follower_rules_set );
            godot::ClassDB::bind_method( godot::D_METHOD( "compare_item_active" ),
                                        &CDDAHost::compare_item_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "compare_item_generation" ),
                                        &CDDAHost::compare_item_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_compare_item_state" ),
                                        &CDDAHost::get_compare_item_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "compare_item_action", "action" ),
                                        &CDDAHost::compare_item_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "end_screen_active" ),
                                        &CDDAHost::end_screen_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "end_screen_generation" ),
                                        &CDDAHost::end_screen_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_end_screen_state" ),
                                        &CDDAHost::get_end_screen_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "end_screen_confirm", "text" ),
                                        &CDDAHost::end_screen_confirm );
            godot::ClassDB::bind_method( godot::D_METHOD( "distraction_active" ),
                                        &CDDAHost::distraction_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "distraction_generation" ),
                                        &CDDAHost::distraction_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_distraction_state" ),
                                        &CDDAHost::get_distraction_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "distraction_action", "action" ),
                                        &CDDAHost::distraction_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "distraction_toggle", "index" ),
                                        &CDDAHost::distraction_toggle );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_note_active" ),
                                        &CDDAHost::auto_note_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_note_generation" ),
                                        &CDDAHost::auto_note_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_auto_note_state" ),
                                        &CDDAHost::get_auto_note_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_note_action", "action" ),
                                        &CDDAHost::auto_note_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_note_toggle", "index" ),
                                        &CDDAHost::auto_note_toggle );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_note_enable", "index" ),
                                        &CDDAHost::auto_note_enable );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_note_disable", "index" ),
                                        &CDDAHost::auto_note_disable );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_note_tab", "tab" ),
                                        &CDDAHost::auto_note_tab );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_note_symbol", "index" ),
                                        &CDDAHost::auto_note_symbol );
            godot::ClassDB::bind_method( godot::D_METHOD( "color_manager_active" ),
                                        &CDDAHost::color_manager_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "color_manager_generation" ),
                                        &CDDAHost::color_manager_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_color_manager_state" ),
                                        &CDDAHost::get_color_manager_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "color_manager_action", "action" ),
                                        &CDDAHost::color_manager_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "color_manager_pick", "encoded" ),
                                        &CDDAHost::color_manager_pick );
            godot::ClassDB::bind_method( godot::D_METHOD( "color_manager_remove", "encoded" ),
                                        &CDDAHost::color_manager_remove );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_active" ),
                                        &CDDAHost::safemode_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_generation" ),
                                        &CDDAHost::safemode_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_safemode_state" ),
                                        &CDDAHost::get_safemode_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_action", "action" ),
                                        &CDDAHost::safemode_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_tab", "tab" ),
                                        &CDDAHost::safemode_tab );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_confirm", "encoded" ),
                                        &CDDAHost::safemode_confirm );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_remove", "row" ),
                                        &CDDAHost::safemode_remove );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_copy", "row" ),
                                        &CDDAHost::safemode_copy );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_swap", "row" ),
                                        &CDDAHost::safemode_swap );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_enable", "row" ),
                                        &CDDAHost::safemode_enable );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_disable", "row" ),
                                        &CDDAHost::safemode_disable );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_move_up", "row" ),
                                        &CDDAHost::safemode_move_up );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_move_down", "row" ),
                                        &CDDAHost::safemode_move_down );
            godot::ClassDB::bind_method( godot::D_METHOD( "safemode_test", "row" ),
                                        &CDDAHost::safemode_test );

            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_active" ),
                                        &CDDAHost::auto_pickup_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_generation" ),
                                        &CDDAHost::auto_pickup_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_auto_pickup_state" ),
                                        &CDDAHost::get_auto_pickup_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_action", "action" ),
                                        &CDDAHost::auto_pickup_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_tab", "tab" ),
                                        &CDDAHost::auto_pickup_tab );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_confirm", "encoded" ),
                                        &CDDAHost::auto_pickup_confirm );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_remove", "row" ),
                                        &CDDAHost::auto_pickup_remove );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_copy", "row" ),
                                        &CDDAHost::auto_pickup_copy );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_swap", "row" ),
                                        &CDDAHost::auto_pickup_swap );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_enable", "row" ),
                                        &CDDAHost::auto_pickup_enable );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_disable", "row" ),
                                        &CDDAHost::auto_pickup_disable );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_move_up", "row" ),
                                        &CDDAHost::auto_pickup_move_up );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_move_down", "row" ),
                                        &CDDAHost::auto_pickup_move_down );
            godot::ClassDB::bind_method( godot::D_METHOD( "auto_pickup_test", "row" ),
                                        &CDDAHost::auto_pickup_test );
            godot::ClassDB::bind_method( godot::D_METHOD( "diary_active" ),
                                        &CDDAHost::diary_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "diary_generation" ),
                                        &CDDAHost::diary_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_diary_state" ),
                                        &CDDAHost::get_diary_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "diary_action", "action" ),
                                        &CDDAHost::diary_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "diary_select_page", "index" ),
                                        &CDDAHost::diary_select_page );
            godot::ClassDB::bind_method( godot::D_METHOD( "diary_select_change", "index" ),
                                        &CDDAHost::diary_select_change );
            godot::ClassDB::bind_method( godot::D_METHOD( "mission_active" ),
                                        &CDDAHost::mission_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "mission_generation" ),
                                        &CDDAHost::mission_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_mission_state" ),
                                        &CDDAHost::get_mission_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "mission_action", "action" ),
                                        &CDDAHost::mission_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "mission_select_row", "index" ),
                                        &CDDAHost::mission_select_row );
            godot::ClassDB::bind_method( godot::D_METHOD( "mission_select_tab", "index" ),
                                        &CDDAHost::mission_select_tab );
            godot::ClassDB::bind_method( godot::D_METHOD( "faction_active" ),
                                        &CDDAHost::faction_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "faction_generation" ),
                                        &CDDAHost::faction_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_faction_state" ),
                                        &CDDAHost::get_faction_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "faction_action", "action" ),
                                        &CDDAHost::faction_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "faction_select_row", "index" ),
                                        &CDDAHost::faction_select_row );
            godot::ClassDB::bind_method( godot::D_METHOD( "faction_select_tab", "index" ),
                                        &CDDAHost::faction_select_tab );
            godot::ClassDB::bind_method( godot::D_METHOD( "advanced_inv_active" ),
                                        &CDDAHost::advanced_inv_active );
            godot::ClassDB::bind_method( godot::D_METHOD( "advanced_inv_generation" ),
                                        &CDDAHost::advanced_inv_generation );
            godot::ClassDB::bind_method( godot::D_METHOD( "get_advanced_inv_state" ),
                                        &CDDAHost::get_advanced_inv_state );
            godot::ClassDB::bind_method( godot::D_METHOD( "advanced_inv_action", "action" ),
                                        &CDDAHost::advanced_inv_action );
            godot::ClassDB::bind_method( godot::D_METHOD( "advanced_inv_select", "side", "index" ),
                                        &CDDAHost::advanced_inv_select );
    ...
    public:
        ...
        /// Open the follower-rules screen on the nearest ally, bypassing the
        /// dialogue tree that normally reaches it -- automating "talk, pick
        /// Rules" is out of scope for a fixture; this is the same shortcut
        /// debug_spawn_npc() is for the screens it unblocks.
        godot::String debug_open_follower_rules()
        {
            return godot::String::utf8( godot_backend::request_debug_open_follower_rules().c_str() );
        }

        /// Open `compare_item_menu` on the avatar's first two inventory item
        /// stacks -- the real path (crafting, the inventory `compare`
        /// command, a gunmod swap) each needs its own fixture to reach.
        godot::String debug_open_compare_item_menu()
        {
            return godot::String::utf8(
                       godot_backend::request_debug_open_compare_item_menu().c_str() );
        }

        /// Open the end-of-game screen without ending the game -- the exact
        /// code path the real death handler runs, minus the death event.
        godot::String debug_open_end_screen()
        {
            return godot::String::utf8( godot_backend::request_debug_open_end_screen().c_str() );
        }
        ...
        godot::String scenario_discover_map_extra( const godot::String &map_extra )
        {
            return godot::String::utf8( godot_backend::request_scenario_discover_map_extra(
                                            std::string( map_extra.utf8().get_data() ) ).c_str() );
        }
        ...
        // --- the study zone skill-preference screen (MENU-13) ---------------
        bool study_zone_active() const
        {
            return godot_backend::get_study_zone_snapshot().active();
        }
        int64_t study_zone_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_study_zone_snapshot().generation() );
        }
        godot::Dictionary get_study_zone_state() const
        {
            return godot_backend::get_study_zone_snapshot().copy_state();
        }
        void study_zone_action( const godot::String &action )
        {
            godot_backend::get_study_zone_snapshot().request_action( action.utf8().get_data() );
        }
        void study_zone_toggle( int skill_index, int npc_index )
        {
            godot_backend::get_study_zone_snapshot().request_toggle( skill_index, npc_index );
        }
        void study_zone_set_filter( const godot::String &text )
        {
            godot_backend::get_study_zone_snapshot().set_filter( text.utf8().get_data() );
        }

        // --- the follower rules screen (MENU-13's last screen) ---------------
        bool follower_rules_active() const
        {
            return godot_backend::get_follower_rules_snapshot().active();
        }
        int64_t follower_rules_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_follower_rules_snapshot().generation() );
        }
        godot::Dictionary get_follower_rules_state() const
        {
            return godot_backend::get_follower_rules_snapshot().copy_state();
        }
        void follower_rules_action( const godot::String &action )
        {
            godot_backend::get_follower_rules_snapshot().request_action( action.utf8().get_data() );
        }
        void follower_rules_toggle( int flag )
        {
            godot_backend::get_follower_rules_snapshot().request_toggle( flag );
        }
        void follower_rules_default_rule( int flag )
        {
            godot_backend::get_follower_rules_snapshot().request_default_rule( flag );
        }
        void follower_rules_set( const godot::String &group, int value )
        {
            godot_backend::get_follower_rules_snapshot().request_set( group.utf8().get_data(), value );
        }

        // --- compare_item_menu (two items side by side) -----------------------
        bool compare_item_active() const
        {
            return godot_backend::get_compare_snapshot().active();
        }
        int64_t compare_item_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_compare_snapshot().generation() );
        }
        godot::Dictionary get_compare_item_state() const
        {
            return godot_backend::get_compare_snapshot().copy_state();
        }
        void compare_item_action( const godot::String &action )
        {
            godot_backend::get_compare_snapshot().request_action( action.utf8().get_data() );
        }

        // --- the end-of-game screen ---------------------------------------------
        bool end_screen_active() const
        {
            return godot_backend::get_end_screen_snapshot().active();
        }
        int64_t end_screen_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_end_screen_snapshot().generation() );
        }
        godot::Dictionary get_end_screen_state() const
        {
            return godot_backend::get_end_screen_snapshot().copy_state();
        }
        void end_screen_confirm( const godot::String &text )
        {
            godot_backend::get_end_screen_snapshot().request_confirm( text.utf8().get_data() );
        }

        // --- the distractions manager (MENU-14's first screen) ---------------
        bool distraction_active() const
        {
            return godot_backend::get_distraction_snapshot().active();
        }
        int64_t distraction_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_distraction_snapshot().generation() );
        }
        godot::Dictionary get_distraction_state() const
        {
            return godot_backend::get_distraction_snapshot().copy_state();
        }
        void distraction_action( const godot::String &action )
        {
            godot_backend::get_distraction_snapshot().request_action( action.utf8().get_data() );
        }
        void distraction_toggle( int index )
        {
            godot_backend::get_distraction_snapshot().request_toggle( index );
        }

        // --- the auto notes manager (MENU-14) ---------------------------------
        bool auto_note_active() const
        {
            return godot_backend::get_auto_note_snapshot().active();
        }
        int64_t auto_note_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_auto_note_snapshot().generation() );
        }
        godot::Dictionary get_auto_note_state() const
        {
            return godot_backend::get_auto_note_snapshot().copy_state();
        }
        void auto_note_action( const godot::String &action )
        {
            godot_backend::get_auto_note_snapshot().request_action( action.utf8().get_data() );
        }
        void auto_note_toggle( int index )
        {
            godot_backend::get_auto_note_snapshot().request_toggle( index );
        }
        void auto_note_enable( int index )
        {
            godot_backend::get_auto_note_snapshot().request_enable( index );
        }
        void auto_note_disable( int index )
        {
            godot_backend::get_auto_note_snapshot().request_disable( index );
        }
        void auto_note_tab( int tab )
        {
            godot_backend::get_auto_note_snapshot().request_tab( tab );
        }
        void auto_note_symbol( int index )
        {
            godot_backend::get_auto_note_snapshot().request_symbol( index );
        }

        // --- the color manager (MENU-14) ---------------------------------------
        bool color_manager_active() const
        {
            return godot_backend::get_color_manager_snapshot().active();
        }
        int64_t color_manager_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_color_manager_snapshot().generation() );
        }
        godot::Dictionary get_color_manager_state() const
        {
            return godot_backend::get_color_manager_snapshot().copy_state();
        }
        void color_manager_action( const godot::String &action )
        {
            godot_backend::get_color_manager_snapshot().request_action( action.utf8().get_data() );
        }
        void color_manager_pick( int encoded )
        {
            godot_backend::get_color_manager_snapshot().request_pick( encoded );
        }
        void color_manager_remove( int encoded )
        {
            godot_backend::get_color_manager_snapshot().request_remove( encoded );
        }

        // --- the safe mode manager (MENU-14) ------------------------------------
        bool safemode_active() const
        {
            return godot_backend::get_safemode_snapshot().active();
        }
        int64_t safemode_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_safemode_snapshot().generation() );
        }
        godot::Dictionary get_safemode_state() const
        {
            return godot_backend::get_safemode_snapshot().copy_state();
        }
        void safemode_action( const godot::String &action )
        {
            godot_backend::get_safemode_snapshot().request_action( action.utf8().get_data() );
        }
        void safemode_tab( int tab )
        {
            godot_backend::get_safemode_snapshot().request_tab( tab );
        }
        void safemode_confirm( int encoded )
        {
            godot_backend::get_safemode_snapshot().request_confirm( encoded );
        }
        void safemode_remove( int row )
        {
            godot_backend::get_safemode_snapshot().request_remove( row );
        }
        void safemode_copy( int row )
        {
            godot_backend::get_safemode_snapshot().request_copy( row );
        }
        void safemode_swap( int row )
        {
            godot_backend::get_safemode_snapshot().request_swap( row );
        }
        void safemode_enable( int row )
        {
            godot_backend::get_safemode_snapshot().request_enable( row );
        }
        void safemode_disable( int row )
        {
            godot_backend::get_safemode_snapshot().request_disable( row );
        }
        void safemode_move_up( int row )
        {
            godot_backend::get_safemode_snapshot().request_move_up( row );
        }
        void safemode_move_down( int row )
        {
            godot_backend::get_safemode_snapshot().request_move_down( row );
        }
        void safemode_test( int row )
        {
            godot_backend::get_safemode_snapshot().request_test( row );
        }

        // --- the auto pickup manager (MENU-14) ----------------------------------
        bool auto_pickup_active() const
        {
            return godot_backend::get_auto_pickup_snapshot().active();
        }
        int64_t auto_pickup_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_auto_pickup_snapshot().generation() );
        }
        godot::Dictionary get_auto_pickup_state() const
        {
            return godot_backend::get_auto_pickup_snapshot().copy_state();
        }
        void auto_pickup_action( const godot::String &action )
        {
            godot_backend::get_auto_pickup_snapshot().request_action( action.utf8().get_data() );
        }
        void auto_pickup_tab( int tab )
        {
            godot_backend::get_auto_pickup_snapshot().request_tab( tab );
        }
        void auto_pickup_confirm( int encoded )
        {
            godot_backend::get_auto_pickup_snapshot().request_confirm( encoded );
        }
        void auto_pickup_remove( int row )
        {
            godot_backend::get_auto_pickup_snapshot().request_remove( row );
        }
        void auto_pickup_copy( int row )
        {
            godot_backend::get_auto_pickup_snapshot().request_copy( row );
        }
        void auto_pickup_swap( int row )
        {
            godot_backend::get_auto_pickup_snapshot().request_swap( row );
        }
        void auto_pickup_enable( int row )
        {
            godot_backend::get_auto_pickup_snapshot().request_enable( row );
        }
        void auto_pickup_disable( int row )
        {
            godot_backend::get_auto_pickup_snapshot().request_disable( row );
        }
        void auto_pickup_move_up( int row )
        {
            godot_backend::get_auto_pickup_snapshot().request_move_up( row );
        }
        void auto_pickup_move_down( int row )
        {
            godot_backend::get_auto_pickup_snapshot().request_move_down( row );
        }
        void auto_pickup_test( int row )
        {
            godot_backend::get_auto_pickup_snapshot().request_test( row );
        }

        // --- the diary screen (MENU-13a) --------------------------------------
        bool diary_active() const
        {
            return godot_backend::get_diary_snapshot().active() &&
                   !godot_backend::get_diary_snapshot().suspended();
        }
        int64_t diary_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_diary_snapshot().generation() );
        }
        godot::Dictionary get_diary_state() const
        {
            return godot_backend::get_diary_snapshot().copy_state();
        }
        void diary_action( const godot::String &action )
        {
            godot_backend::get_diary_snapshot().request_action( action.utf8().get_data() );
        }
        void diary_select_page( int index )
        {
            godot_backend::get_diary_snapshot().request_select_page( index );
        }
        void diary_select_change( int index )
        {
            godot_backend::get_diary_snapshot().request_select_change( index );
        }

        // --- the missions screen (MENU-13) -----------------------------------
        bool mission_active() const
        {
            return godot_backend::get_mission_snapshot().active();
        }
        int64_t mission_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_mission_snapshot().generation() );
        }
        godot::Dictionary get_mission_state() const
        {
            return godot_backend::get_mission_snapshot().copy_state();
        }
        void mission_action( const godot::String &action )
        {
            godot_backend::get_mission_snapshot().request_action( action.utf8().get_data() );
        }
        void mission_select_row( int index )
        {
            godot_backend::get_mission_snapshot().request_select( index );
        }
        void mission_select_tab( int index )
        {
            godot_backend::get_mission_snapshot().request_tab( index );
        }

        // --- the faction screen (MENU-13) ------------------------------------
        bool faction_active() const
        {
            return godot_backend::get_faction_snapshot().active();
        }
        int64_t faction_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_faction_snapshot().generation() );
        }
        godot::Dictionary get_faction_state() const
        {
            return godot_backend::get_faction_snapshot().copy_state();
        }
        void faction_action( const godot::String &action )
        {
            godot_backend::get_faction_snapshot().request_action( action.utf8().get_data() );
        }
        void faction_select_row( int index )
        {
            godot_backend::get_faction_snapshot().request_select( index );
        }
        void faction_select_tab( int index )
        {
            godot_backend::get_faction_snapshot().request_tab( index );
        }

        // --- the advanced inventory manager (MENU-8) -------------------------
        bool advanced_inv_active() const
        {
            return godot_backend::get_advanced_inv_snapshot().active();
        }
        int64_t advanced_inv_generation() const
        {
            return static_cast<int64_t>( godot_backend::get_advanced_inv_snapshot().generation() );
        }
        godot::Dictionary get_advanced_inv_state() const
        {
            return godot_backend::get_advanced_inv_snapshot().copy_state();
        }
        void advanced_inv_action( const godot::String &action )
        {
            godot_backend::get_advanced_inv_snapshot().request_action( action.utf8().get_data() );
        }
        void advanced_inv_select( int side, int index )
        {
            godot_backend::get_advanced_inv_snapshot().request_select( side, index );
        }
        ...
        {
            // 33: the diary screen (MENU-13a) has a channel. An old library
            // answers has_method() false for it, so the panel never attends
            // and the screen falls back to the legacy curses screen after
            // its 1.5s timeout -- playable, silently unmigrated. Diary
            // migration also unblocks observing the scores screen (MENU-13),
            // whose only callers were the death screen and a row inside the
            // diary.
            // 32: the advanced inventory manager (MENU-8) has a channel. An
            // old library answers has_method() false for it, so the panel
            // never attends and the screen falls back to the legacy loop
            // after its 1.5s timeout -- playable, silently unmigrated.
            // 31: the faction screen (MENU-13) has a channel. An old library
            // answers has_method() false for it, so the panel never attends
            // and the screen falls back to the ImGui overlay after its 1.5s
            // timeout -- playable, silently unmigrated. 30: the missions
            // screen (MENU-13) has a channel. An old library
            // answers has_method() false for it, so the panel never attends and
            // the screen falls back to the ImGui overlay after its 1.5s timeout
            // -- playable, silently unmigrated. 29: the study zone
            // skill-preference screen (MENU-13) has a
            // channel. An old library answers has_method() false for it, so
            // the panel never attends and the screen falls back to the ImGui
            // overlay after its 1.5s timeout -- playable, silently
            // unmigrated. 28: MENU-13's first three screens have channels --
            // martial arts, scores, medical. An old library answers
            // has_method() false for all of them, so their panels never
            // attend, and every one of those screens falls back to the
            // ImGui overlay after its 1.5s timeout: playable, silently
            // unmigrated, and indistinguishable from work that was never
            // done. 27: rot_flags bits 16-30 carry the interned tile id and
            // get_map_ident_table() resolves them (3D-8d); 26 added
            // cmd_shape in bits 13-15 (3D-8c). An old library leaves both
            // zero, which reads as "no claim" and quietly costs shapes and
            // meshes alike -- exactly the mixed state the handshake turns
